...
public:
	...
	static bool AabbWithSphere(const BoundingBox& aabb, const Sphere& sphere);
	...
	static bool FrustumPlaneWithAabb(const BoundingBox& aabb, const glm::vec3& normal, const float distance);
