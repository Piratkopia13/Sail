...
FXAAStage::FXAAStage(UINT width, UINT height, Model* fullScreenQuad) : PostProcessStage(width, height, fullScreenQuad) {
	...
	auto psBlob = ShaderSet::compileShader(L"postprocess/FXAAShader.hlsl", "PSMain", "ps_5_0");
...
void FXAAStage::run(RenderableTexture& inputTexture) {
	// TODO: fix
...
void FXAAStage::resize(UINT width, UINT height) {
