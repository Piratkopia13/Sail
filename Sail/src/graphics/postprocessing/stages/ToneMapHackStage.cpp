#include "ToneMapHackStage.h"

ToneMapHackStage::ToneMapHackStage(UINT width, UINT height, Model* fullscreenQuad)
	: PostProcessStage(width, height, fullscreenQuad)
{
	...
	auto vsBlob = ShaderSet::compileShader(L"postprocess/ToneMapHack.hlsl", "VSMain", "vs_5_0");
	auto psBlob = ShaderSet::compileShader(L"postprocess/ToneMapHack.hlsl", "PSMain", "ps_5_0");
...
ToneMapHackStage::~ToneMapHackStage() {
}

void ToneMapHackStage::run(RenderableTexture& inputTexture) {
	// TODO: fix
