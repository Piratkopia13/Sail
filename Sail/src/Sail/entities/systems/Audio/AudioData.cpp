...
#pragma region DEFINING playerEntity SOUNDS
	...
	{
		//	• Sample #1
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/footsteps/footsteps_metal_1.wav";
		...
		//	• Sample #2
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/footsteps/footsteps_metal_2.wav";
		soundUniqueInfo.soundEffectLength = 0.941f;
		soundUniqueInfo.volume = 0.7f;
		AllAudioData::m_soundsUnique[Audio::RUN_METAL].push_back(soundUniqueInfo);

		//	• Sample #3
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/footsteps/footsteps_metal_3.wav";
		soundUniqueInfo.soundEffectLength = 0.921f;
		soundUniqueInfo.volume = 0.7f;
		AllAudioData::m_soundsUnique[Audio::RUN_METAL].push_back(soundUniqueInfo);

		//	• Sample #4
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/footsteps/footsteps_metal_4.wav";
	...
	{
		//	• Sample #1
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/footsteps/footsteps_tile_1.wav";
		soundUniqueInfo.soundEffectLength = 0.919f;
		soundUniqueInfo.volume = 1.0f;
		AllAudioData::m_soundsUnique[Audio::RUN_TILE].push_back(soundUniqueInfo);
		//	• Sample #2
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/footsteps/footsteps_tile_2.wav";
		soundUniqueInfo.soundEffectLength = 0.941f;
		soundUniqueInfo.volume = 1.0f;
		AllAudioData::m_soundsUnique[Audio::RUN_TILE].push_back(soundUniqueInfo);
		//	• Sample #3
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/footsteps/footsteps_tile_3.wav";
		soundUniqueInfo.soundEffectLength = 0.921f;
		soundUniqueInfo.volume = 1.0f;
		AllAudioData::m_soundsUnique[Audio::RUN_TILE].push_back(soundUniqueInfo);
		//	• Sample #4
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/footsteps/footsteps_tile_4.wav";
		soundUniqueInfo.soundEffectLength = 0.936f;
		soundUniqueInfo.volume = 1.0f;
		AllAudioData::m_soundsUnique[Audio::RUN_TILE].push_back(soundUniqueInfo);
	}
	...
	{
		//	• Sample #1
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/footsteps/footsteps_water_metal_1.wav";
		soundUniqueInfo.soundEffectLength = 0.919f;
		soundUniqueInfo.volume = 1.0f;
		AllAudioData::m_soundsUnique[Audio::RUN_WATER_METAL].push_back(soundUniqueInfo);
		//	• Sample #2
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/footsteps/footsteps_water_metal_2.wav";
		soundUniqueInfo.soundEffectLength = 0.941f;
		soundUniqueInfo.volume = 1.0f;
		AllAudioData::m_soundsUnique[Audio::RUN_WATER_METAL].push_back(soundUniqueInfo);
		//	• Sample #3
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/footsteps/footsteps_water_metal_3.wav";
		soundUniqueInfo.soundEffectLength = 0.921f;
		soundUniqueInfo.volume = 1.0f;
		AllAudioData::m_soundsUnique[Audio::RUN_WATER_METAL].push_back(soundUniqueInfo);
		//	• Sample #4
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/footsteps/footsteps_water_metal_4.wav";
		soundUniqueInfo.soundEffectLength = 0.936f;
		soundUniqueInfo.volume = 1.0f;
		AllAudioData::m_soundsUnique[Audio::RUN_WATER_METAL].push_back(soundUniqueInfo);
	}
	...
	{
		//	• Sample #1
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/footsteps/footsteps_water_tile_1.wav";
		soundUniqueInfo.soundEffectLength = 0.919f;
		soundUniqueInfo.volume = 1.0f;
		AllAudioData::m_soundsUnique[Audio::RUN_WATER_TILE].push_back(soundUniqueInfo);
		//	• Sample #2
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/footsteps/footsteps_water_tile_2.wav";
		soundUniqueInfo.soundEffectLength = 0.941f;
		soundUniqueInfo.volume = 1.0f;
		AllAudioData::m_soundsUnique[Audio::RUN_WATER_TILE].push_back(soundUniqueInfo);
		//	• Sample #3
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/footsteps/footsteps_water_tile_3.wav";
		soundUniqueInfo.soundEffectLength = 0.921f;
		soundUniqueInfo.volume = 1.0f;
		AllAudioData::m_soundsUnique[Audio::RUN_WATER_TILE].push_back(soundUniqueInfo);
		//	• Sample #4
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/footsteps/footsteps_water_tile_4.wav";
		soundUniqueInfo.soundEffectLength = 0.936f;
		soundUniqueInfo.volume = 1.0f;
		AllAudioData::m_soundsUnique[Audio::RUN_WATER_TILE].push_back(soundUniqueInfo);
	}
	...
	{
		//	• Sample #1
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/watergun/watergun_start.wav";
	...
	{
		//	• Sample #1
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/watergun/watergun_loop.wav";
	...
	{
		//	• Sample #1
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/watergun/watergun_end.wav";
	...
	{
		//	• Sample #1
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/watergun/watergun_reload.wav";
	...
	{
		//	• Sample #1
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/impacts/water_drip_1.wav";
		...
		//	• Sample #2
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/impacts/water_drip_2.wav";
		soundUniqueInfo.soundEffectLength = 0.299f;
		soundUniqueInfo.volume = 0.7f;
		AllAudioData::m_soundsUnique[Audio::WATER_IMPACT_ENVIRONMENT].push_back(soundUniqueInfo);
		//	• Sample #3
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/impacts/water_drip_3.wav";
		soundUniqueInfo.soundEffectLength = 0.26f;
		soundUniqueInfo.volume = 0.7f;
		AllAudioData::m_soundsUnique[Audio::WATER_IMPACT_ENVIRONMENT].push_back(soundUniqueInfo);
		//	• Sample #4
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/impacts/water_drip_4.wav";
		soundUniqueInfo.soundEffectLength = 0.207f;
		soundUniqueInfo.volume = 0.7f;
		AllAudioData::m_soundsUnique[Audio::WATER_IMPACT_ENVIRONMENT].push_back(soundUniqueInfo);
		//	• Sample #5
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/impacts/water_drip_5.wav";
		soundUniqueInfo.soundEffectLength = 0.406f;
		soundUniqueInfo.volume = 0.7f;
		AllAudioData::m_soundsUnique[Audio::WATER_IMPACT_ENVIRONMENT].push_back(soundUniqueInfo);
		//	• Sample #6
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/impacts/water_drip_6.wav";
		soundUniqueInfo.soundEffectLength = 0.463f;
		soundUniqueInfo.volume = 0.7f;
		AllAudioData::m_soundsUnique[Audio::WATER_IMPACT_ENVIRONMENT].push_back(soundUniqueInfo);
		//	• Sample #7
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/impacts/water_drip_7.wav";
	...
	{
		//	• Sample #1
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/impacts/water_impact_enemy_candle.wav";
	...
	{
		//	• Sample #1
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/impacts/water_impact_my_candle.wav";
	...
	{
		//	• Sample #1
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/jumping/jump.wav";
	...
	{
		//	• Sample #1
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/jumping/landing_ground.wav";
	...
	{
		//	• Sample #1
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/death/death_1.wav";
		soundUniqueInfo.soundEffectLength = 4.013f;
		soundUniqueInfo.volume = 1.0f;
		AllAudioData::m_soundsUnique[Audio::DEATH].push_back(soundUniqueInfo);
		//	• Sample #2
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/death/death_2.wav";
		soundUniqueInfo.soundEffectLength = 4.013f;
		soundUniqueInfo.volume = 1.0f;
		AllAudioData::m_soundsUnique[Audio::DEATH].push_back(soundUniqueInfo);
		//	• Sample #3
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/death/death_3.wav";
		soundUniqueInfo.soundEffectLength = 4.013f;
		soundUniqueInfo.volume = 1.0f;
		AllAudioData::m_soundsUnique[Audio::DEATH].push_back(soundUniqueInfo);
		//	• Sample #4
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/death/death_4.wav";
		soundUniqueInfo.soundEffectLength = 4.013f;
		soundUniqueInfo.volume = 1.0f;
		AllAudioData::m_soundsUnique[Audio::DEATH].push_back(soundUniqueInfo);
		//	• Sample #5
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/death/death_5.wav";
		soundUniqueInfo.soundEffectLength = 4.013f;
		soundUniqueInfo.volume = 1.0f;
		AllAudioData::m_soundsUnique[Audio::DEATH].push_back(soundUniqueInfo);
		//	• Sample #6
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/death/death_6.wav";
		soundUniqueInfo.soundEffectLength = 4.013f;
		soundUniqueInfo.volume = 1.0f;
		AllAudioData::m_soundsUnique[Audio::DEATH].push_back(soundUniqueInfo);
	}
	...
	{
		//	• Sample #1
		soundUniqueInfo.fileName = "../SPLASH/res/sounds/death/killing_blow.wav";
