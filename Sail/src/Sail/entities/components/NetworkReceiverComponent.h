...
public:
	...
	*/
	NetworkReceiverComponent(Netcode::NetworkComponentID id, Netcode::EntityType type) : m_id(id), m_entityType(type) {}
	~NetworkReceiverComponent() {}

	Netcode::NetworkComponentID m_id; // Same as the ID used by whoever is sending the information to this entity
