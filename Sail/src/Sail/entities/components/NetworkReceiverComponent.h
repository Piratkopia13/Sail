...
public:
	...
	*/
	NetworkReceiverComponent(Netcode::NetworkObjectID id, Netcode::EntityType type) : m_id(id), m_entityType(type) {}
	~NetworkReceiverComponent() {}

	Netcode::NetworkObjectID m_id; // Same as the ID used by whoever is sending the information to this entity
