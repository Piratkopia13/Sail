#include "VGaussianBlurDepthTest.h"

#include "../../shader/ShaderSet.h"
#include "../../../Application.h"

VGaussianBlurDepthTest::VGaussianBlurDepthTest(UINT width, UINT height, Model* fullscreenQuad)
	: PostProcessStage(width, height, fullscreenQuad)
{
	...
	auto psBlob = ShaderSet::compileShader(L"postprocess/GaussianBlurWithDepthCheck.hlsl", "PSVertical", "ps_5_0");
...
VGaussianBlurDepthTest::~VGaussianBlurDepthTest() {
}

void VGaussianBlurDepthTest::setDepthSRV(ID3D11ShaderResourceView** depthSRV) {
	m_depthSRV = depthSRV;
}

void VGaussianBlurDepthTest::run(RenderableTexture& inputTexture) {
	// TODO: fix
